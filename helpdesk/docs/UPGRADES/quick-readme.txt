...
This is for people who haven`t done anything with the original code/layout except maybe update the logo.

This includes changes to any editable PHP system files.
...
3. Remove 'control/connect.inc.php' & 'licence.lic' from the new file set.  

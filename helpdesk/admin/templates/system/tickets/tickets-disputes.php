...
<div class="content">
  ...
  <div class="header">
    ...
    ?>
    <h1 class="page-title"><?php echo $msg_adheader28; ?> (<?php echo @number_format($countedRows); ?>)</h1>
  ...
  <ul class="breadcrumb">
    ...
    <li class="active"><?php echo $msg_adheader28; ?></li>
  </ul>
	  ...
	  <div class="well">
       <table class="table table-striped table-hover">
        ...
        <tbody>
		 ...
		 ?>
         <tr>
          <td><a href="?p=view-dispute&amp;id=<?php echo $TICKETS->ticketID; ?>" title="<?php echo mswSpecialChars($msg_viewticket11); ?>"><?php echo mswTicketNumber($TICKETS->ticketID); ?></a>

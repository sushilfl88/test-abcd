...
<div class="content">
  ...
  <div class="header">
	...
	?>
    <h1 class="page-title"><?php echo $msg_adheader29; ?> (<?php echo @number_format($countedRows); ?>)</h1>
  ...
  <ul class="breadcrumb">
    ...
    <li class="active"><?php echo $msg_adheader29; ?></li>
  </ul>
  ...
  <div class="container-fluid">
	...
	<div class="row-fluid" style="margin-top:15px">
       ...
       <table class="table table-striped table-hover">
        ...
        <tbody>
         ...
         <tr>
		  ...
		  ?>
          <td><a href="?p=view-dispute&amp;id=<?php echo $TICKETS->ticketID; ?>" title="<?php echo mswSpecialChars($msg_user29); ?>"><?php echo mswTicketNumber($TICKETS->ticketID); ?></a>
		  <span class="ticketPriority"><?php echo mswCleanData($TICKETS->levelName); ?></span></td>
		 ...
		 <tr class="warning nothing_to_see">
		  <td colspan="<?php echo (USER_DEL_PRIV=='yes' ? '5' : '4'); ?>"><?php echo $msg_open10; ?></td>
		 </tr> 
		 <?php
		 }
		 ?>
	  ...
	  <div class="btn-toolbar" style="margin-top:0;padding-top:0">
	   ...
	   if (USER_DEL_PRIV=='yes') {
	   ?>
       <button onclick="ms_confirmButtonAction('form','<?php echo mswSpecialChars($msg_script_action); ?>','delete');return false;" class="btn btn-danger" disabled="disabled" type="submit" id="delButton"><i class="icon-trash"></i> <?php echo mswCleanData($msg_open23); ?> <span id="mc_countVal">(0)</span></button>
	   <?php
	   }
	   ?>
       <button onclick="ms_confirmButtonAction('form','<?php echo mswSpecialChars($msg_script_action); ?>','re-open');return false;" class="btn btn-info" disabled="disabled" type="submit" id="delButton2"><i class="icon-unlock"></i> <?php echo mswCleanData($msg_open40); ?> <span id="mc_countVal2">(0)</span></button>
	  </div>
      <?php
	  }

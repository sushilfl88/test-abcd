...
$q = mysql_query("SELECT SQL_CALC_FOUND_ROWS *,
     ...
     WHERE `ticketStatus` = 'submit_report'
     AND `isDisputed`     = 'no'
...
<div class="content">
  ...
  <div class="header">
    ...
    ?>
    <h1 class="page-title"><?php echo $msg_adheader65; ?> (<?php echo @number_format($countedRows); ?>)</h1>
  ...
  <ul class="breadcrumb">
    ...
    <li class="active"><?php echo $msg_adheader65; ?></li>
  </ul>

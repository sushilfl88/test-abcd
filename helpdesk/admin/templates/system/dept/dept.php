...
<div class="content">
  ...
  <div class="header">
	...
	<h1 class="page-title"><?php echo (isset($EDIT->id) ? $msg_dept5 : $msg_dept2); ?></h1>
  ...
  <div class="container-fluid" style="margin-top:20px">
	...
	<div class="row-fluid">
	  <ul class="nav nav-tabs" id="tabArea">
       <li class="active"><a href="#one" data-toggle="tab"><i class="icon-file-text-alt"></i> <?php echo $msg_dept24; ?></a></li>
	  ...
	  <div class="btn-toolbar" style="margin-top:0;padding-top:0">
       ...
       <button class="btn btn-primary" type="submit"><i<?php echo (isset($EDIT->id) ? ' class="icon-ok"' : ' class="icon-plus"'); ?>></i> <?php echo (isset($EDIT->id) ? $msg_dept5 : $msg_dept2); ?></button>
       <?php
	   if (isset($EDIT->id)) {
	   ?>

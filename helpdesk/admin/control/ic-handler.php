...
function ioncube_event_handler($err_code,$params) {
  switch($err_code) {
    ...
    break;
    case 'EXP':
    $e_msg = 'This beta version has expired. All beta versions are valid for 1 month only.<br><br>If you are an active beta tester, please contact me for a new licence file.<br><br><span style="font-weight:normal"><a href="mailto:support@maianscriptworld.co.uk?subject=Beta%20Licence">support@maianscriptworld.co.uk</a></span><br><br>Remember that beta versions should NOT be used in a production environment.';
    break;
    default:
    $e_msg = '';
